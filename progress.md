...
- **#2** README has no section for the 2026-05 modules that have no user-facing docs yet: the asyncio engine and `bench` subcommand, the cloud worker launchers, the chaos helpers, the extra report formats (Allure, cost, CycloneDX, Excel, histogram, PDF, SARIF, service map) and `deploy/`. `CLAUDE.md` was updated on 2026-09-23.
